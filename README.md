...
3. Для нужного компьютера откройте **Редактировать** и заполните поле **Описание экрана**.
4. После этого в правом верхнем углу карточки появляется бейдж статуса LLM:
