...
Для слишком больших скриншотов Viewer автоматически уменьшает изображение перед отправкой в `llama-server`, чтобы multimodal-анализ не упирался в многоминутную обработку одного кадра.
