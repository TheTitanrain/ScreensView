...
2. В диалоге **Добавить компьютер** заполнить секции **Компьютер**, **Подключение** и при необходимости **Описание экрана**: имя, хост, порт и API-ключ
...
6. При необходимости откройте **Настройки** и включите **Автозапуск**, чтобы Viewer запускался вместе с Windows
...
- Верхний toolbar после этого содержит только действия: **Компьютеры**, **Запустить/Остановить**, **Обновить сейчас**, **Настройки**, **О программе**.
