...
3. Если выбран backend `CUDA (NVIDIA)`, Viewer скачивает и сам `llama-server`, и отдельный архив с CUDA runtime DLL. Если после переключения на CUDA статус backend показывает `Не скачан`, нажмите **Скачать** в секции backend, чтобы обновить локальные бинарники.
