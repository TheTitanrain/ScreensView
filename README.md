...
2. При первом запуске выберите модель и нажмите **Скачать**. По умолчанию выбран совместимый `LLaVA v1.5 7B`. В списке также доступна экспериментальная `Gemma 4 E2B`.
