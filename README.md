...
9. Click cards to select computers in the main grid. Use **Ctrl+click** to add or remove cards, **Shift+click** to select a range, and **Ctrl+A** to select all cards. Right-clicking a selected card opens the context menu for the selected computers; **Open** and **Edit** still target the card that opened the menu, while applicable actions such as **Run LLM now**, **Ping**, remote access, power actions, and **Delete** apply to the selection.
