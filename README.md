...
> При отсутствии активного пользователя на консоли (никто не залогинен) `/screenshot` возвращает **HTTP 503** вместо скриншота. Это штатное поведение — агент не может захватить экран в отсутствие пользовательской сессии.
