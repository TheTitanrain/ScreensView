...
9. Карточки в основной сетке можно выбирать кликом. Используйте **Ctrl+клик**, чтобы добавить или убрать карточку, и **Shift+клик**, чтобы выбрать диапазон. Правый клик по выбранной карточке открывает контекстное меню для выбранных компьютеров; **Открыть** и **Редактировать** остаются действиями для карточки, по которой открыто меню, а применимые действия вроде **Запустить LLM сейчас**, **Пинг**, удалённого доступа, управления питанием и **Удалить** выполняются для всего выбора.
